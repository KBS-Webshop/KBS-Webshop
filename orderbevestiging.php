...
<h4><?php print $naam?> bedankt voor uw bestelling bij nerdygatgets! uw bestel nummer is <?php print $orderID?></h4>
...
<div class="winkelmand-wrapper">
    <ul class="winkelmand">
        <div id="ResultsArea" class="Winkelmand">
            ...
            <h1 class="StockItemID1">
                <?php print($StockItem["StockItemName"]."<br><br>aantal: ". $item['amount']) ?>
...
?>
<h3 class="StockItemPriceTextbevestiging">
    Totaalprijs: € <?php print str_replace(".",",",$totalprice)?>
</h3>
<h3 class="verzendadres">
    verzendadres:
</h3>
